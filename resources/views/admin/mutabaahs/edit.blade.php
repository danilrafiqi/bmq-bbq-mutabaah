    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{action('MutabaahController@update', $id)}}">
                        @csrf
                    <input name="_method" type="hidden" value="PATCH">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="sholat_wajib" type="text" data-slider-min="0" data-slider-max="35" data-slider-step="1" data-slider-value="{{$mutabaah->sholat_wajib}}" name="sholat_wajib" />
                                <span id="">Jumlah : 
                                    <span id="sholat_wajib_val">{{$mutabaah->sholat_wajib}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jamaah_awal_waktu" type="text" data-slider-min="0" data-slider-max="35" data-slider-step="1" data-slider-value="{{$mutabaah->jamaah_awal_waktu}}" name="jamaah_awal_waktu" />
                                <span id="">Jumlah : 
                                    <span id="jamaah_awal_waktu_val">{{$mutabaah->jamaah_awal_waktu}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="subuh_jamaah" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->subuh_jamaah}}" name="subuh_jamaah" />
                                <span id="">Jumlah : 
                                    <span id="subuh_jamaah_val">{{$mutabaah->subuh_jamaah}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="qiyamul_lail" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->qiyamul_lail}}" name="qiyamul_lail" />
                                <span id="">Jumlah : 
                                    <span id="qiyamul_lail_val">{{$mutabaah->qiyamul_lail}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="witir" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->witir}}" name="witir" />
                                <span id="">Jumlah : 
                                    <span id="witir_val">{{$mutabaah->witir}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="istighfar" type="text" data-slider-min="0" data-slider-max="1000" data-slider-step="1" data-slider-value="{{$mutabaah->istighfar}}" name="istighfar" />
                                <span id="">Jumlah : 
                                    <span id="istighfar_val">{{$mutabaah->istighfar}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="puasa_sunah" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->puasa_sunah}}" name="puasa_sunah" />
                                <span id="">Jumlah : 
                                    <span id="puasa_sunah_val">{{$mutabaah->puasa_sunah}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="tilawah" type="text" data-slider-min="0" data-slider-max="70" data-slider-step="1" data-slider-value="{{$mutabaah->tilawah}}" name="tilawah" />
                                <span id="">Jumlah : 
                                    <span id="tilawah_val">{{$mutabaah->tilawah}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="matsurat" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->matsurat}}" name="matsurat" />
                                <span id="">Jumlah : 
                                    <span id="matsurat_val">{{$mutabaah->matsurat}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="duha" type="text" data-slider-min="0" data-slider-max="7" data-slider-step="1" data-slider-value="{{$mutabaah->duha}}" name="duha" />
                                <span id="">Jumlah : 
                                    <span id="duha_val">{{$mutabaah->duha}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="baca_buku_islam" type="text" data-slider-min="0" data-slider-max="50" data-slider-step="1" data-slider-value="{{$mutabaah->baca_buku_islam}}" name="baca_buku_islam" />
                                <span id="">Jumlah : 
                                    <span id="baca_buku_islam_val">{{$mutabaah->baca_buku_islam}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hafalan_quran" type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="{{$mutabaah->hafalan_quran}}" name="hafalan_quran" />
                                <span id="">Jumlah : 
                                    <span id="hafalan_quran_val">{{$mutabaah->hafalan_quran}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="hafalan_hadis" type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="{{$mutabaah->hafalan_hadis}}" name="hafalan_hadis" />
                                <span id="">Jumlah : 
                                    <span id="hafalan_hadis_val">{{$mutabaah->hafalan_hadis}}</span>
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="minggu" type="text" data-slider-min="0" data-slider-max="12" data-slider-step="1" data-slider-value="{{$mutabaah->minggu}}" name="minggu" />
                                <span id="">Jumlah : 
                                    <span id="minggu_val">{{$mutabaah->minggu}}</span>
                                </span>
                            </div>
                        </div>
